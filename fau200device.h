/* FAU200 device class - Version 1.0.2
...
#ifndef FAU200DEVICE_H
#define FAU200DEVICE_H
...
public:
    ...
    static const uint16_t PID = 0x8c35;                          // USB product ID
    ...
    explicit FAU200Device();  // Explicit since version 1.0.2
